#!/bin/bash
#SBATCH --job-name=rl-llm-notebook-multigpu
...
# Print job info
echo "========================================"
echo "RL-LLM Notebook Training (Multi-GPU)"
echo "========================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Node: $SLURM_NODELIST"
echo "Starting time: $(date)"
echo "GPUs requested: 2x A100-80GB (160GB total VRAM)"
echo ""
...
echo "Executing notebook with 2x A100-80GB GPUs..."
